...
const Grok_4_Fast_Non_Reasoning_Literal = "grok-4-fast-non-reasoning";
const Grok_4_Fast_Non_Reasoning_Description =
  "Grok-4 Fast Non-Reasoning is xAI's fast model without reasoning capabilities with a 2M context window.";

const Grok_4_Fast_Non_Reasoning_Schema = ChatModelSchema(XAIChatModelRoles, XAIChatModelTextToolModalitiesEnum).parse({
  ...
  price: pricingData[Grok_4_Fast_Non_Reasoning_Literal],
});

const Grok_4_Fast_Non_Reasoning_Options = BaseChatModelOptions;
type Grok_4_Fast_Non_Reasoning_OptionsType = z.infer<typeof Grok_4_Fast_Non_Reasoning_Options>;

class Grok_4_Fast_Non_Reasoning extends BaseChatModel {
  constructor(options: Grok_4_Fast_Non_Reasoning_OptionsType) {
    super(Grok_4_Fast_Non_Reasoning_Schema, options);
  }
}

export { Grok_4_Fast_Non_Reasoning, Grok_4_Fast_Non_Reasoning_Literal, Grok_4_Fast_Non_Reasoning_Options, Grok_4_Fast_Non_Reasoning_Schema, type Grok_4_Fast_Non_Reasoning_OptionsType };

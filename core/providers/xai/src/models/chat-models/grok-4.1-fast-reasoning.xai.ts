...
const Grok_4_1_Fast_Reasoning_Literal = "grok-4.1-fast-reasoning";
const Grok_4_1_Fast_Reasoning_Description =
  "Grok-4.1 Fast Reasoning is xAI's updated fast reasoning model with a 2M context window.";

const Grok_4_1_Fast_Reasoning_Schema = ChatModelSchema(XAIChatModelRoles, XAIChatModelTextToolModalitiesEnum).parse({
  ...
  price: pricingData["grok-4.1-fast-reasoning"],
});

const Grok_4_1_Fast_Reasoning_Options = BaseChatModelOptions;
type Grok_4_1_Fast_Reasoning_OptionsType = z.infer<typeof Grok_4_1_Fast_Reasoning_Options>;

class Grok_4_1_Fast_Reasoning extends BaseChatModel {
  constructor(options: Grok_4_1_Fast_Reasoning_OptionsType) {
    super(Grok_4_1_Fast_Reasoning_Schema, options);
  }
}

export { Grok_4_1_Fast_Reasoning, Grok_4_1_Fast_Reasoning_Literal, Grok_4_1_Fast_Reasoning_Options, Grok_4_1_Fast_Reasoning_Schema, type Grok_4_1_Fast_Reasoning_OptionsType };

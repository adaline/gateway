...
const Grok_3_Mini_Fast_Beta_Literal = "grok-3-mini-fast-beta";
const Grok_3_Mini_Fast_Beta_Description =
  "Grok-3 Mini Fast Beta is xAI's fast lightweight model optimized for speed with a 131K context window.";

const Grok_3_Mini_Fast_Beta_Schema = ChatModelSchema(XAIChatModelRoles, XAIChatModelTextToolModalitiesEnum).parse({
  ...
  price: pricingData[Grok_3_Mini_Fast_Beta_Literal],
});

const Grok_3_Mini_Fast_Beta_Options = BaseChatModelOptions;
type Grok_3_Mini_Fast_Beta_OptionsType = z.infer<typeof Grok_3_Mini_Fast_Beta_Options>;

class Grok_3_Mini_Fast_Beta extends BaseChatModel {
  constructor(options: Grok_3_Mini_Fast_Beta_OptionsType) {
    super(Grok_3_Mini_Fast_Beta_Schema, options);
  }
}

export { Grok_3_Mini_Fast_Beta, Grok_3_Mini_Fast_Beta_Literal, Grok_3_Mini_Fast_Beta_Options, Grok_3_Mini_Fast_Beta_Schema, type Grok_3_Mini_Fast_Beta_OptionsType };

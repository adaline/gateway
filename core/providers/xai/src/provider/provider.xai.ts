...
class XAI<C extends Models.BaseChatModelOptionsType> implements ProviderV1<C, never> {
  ...
  > = {
    ...
    [Models.Grok_2_Vision_Literal]: {
      model: Models.Grok_2_Vision,
      modelOptions: Models.Grok_2_Vision_Options,
      modelSchema: Models.Grok_2_Vision_Schema,
    },
    [Models.Grok_2_Vision_Latest_Literal]: {
      model: Models.Grok_2_Vision_Latest,
      modelOptions: Models.Grok_2_Vision_Latest_Options,
      modelSchema: Models.Grok_2_Vision_Latest_Schema,
    },
    [Models.Grok_2_Vision_1212_Literal]: {
      model: Models.Grok_2_Vision_1212,
      modelOptions: Models.Grok_2_Vision_1212_Options,
      modelSchema: Models.Grok_2_Vision_1212_Schema,
    },

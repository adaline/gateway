...
import { OpenRouterChatModelConfigs } from "../../../src/configs";
import { BaseChatModel } from "../../../src/models";
import { OpenRouterChatRequestType, OpenRouterCompleteChatResponse } from "../../../src/models/chat-models/types";
...
describe("BaseChatModel", () => {
  ...
  describe("constructor", () => {
    it("should initialize properties correctly", () => {
      ...
      expect(baseChatModel.getDefaultBaseUrl()).toBe("https://openrouter.ai/api/v1");
    });
  });
  ...
  describe("getDefaultBaseUrl", () => {
    it("should return the baseUrl without trailing slash", () => {
      ...
      expect(model.getDefaultBaseUrl()).toBe("https://openrouter.ai/api/v1");
    });
  });
  ...
  describe("BaseChatModel transformMessages", () => {
    ...
    it("should throw InvalidMessagesError for PDF modality (not supported by Open Router)", () => {
      const messages: MessageType[] = [
        {
          role: UserRoleLiteral,
          content: [
    ...
    it("should correctly transform a simple System message", () => {
      ...
      const expected: OpenRouterChatRequestType = {
        messages: [
          {
  ...
  describe("transformCompleteChatResponse", () => {
    ...
    describe("transformCompleteChatResponse", () => {
      ...
      it("should omit optional usage and logProbs if not present in response (though OpenAI usually includes usage)", () => {
        ...
        const safeMinimal = OpenRouterCompleteChatResponse.safeParse(responseMinimal);
          ...
          choices: [
            {
              ...
              message: {
                ...
                tool_calls: [
                  {
                    // Missing 'id' which is required by OpenRouterCompleteChatResponse schema
                    type: "function",
